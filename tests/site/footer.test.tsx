...
describe('SiteFooter', () => {
  it('renders Swiss/EU imprint essentials and legal catalog routes (EN)', () => {
    ...
    expect(html).toContain('Registered address coming soon')
    expect(html).toContain('UID / VAT registration coming soon')
    expect(html).toContain('Contact form')
    expect(html).toContain('href="/contact"')
    expect(html).not.toContain('hello@nexusscope.example')
    expect(html).not.toContain('CHE-XXX.XXX.XXX')
    expect(html).not.toContain('[Legal form')
  ...
  it('renders bilingual DE labels and disclaimer', () => {
    ...
    expect(html).toContain('regulatorische Orientierungsinformationen')
    expect(html).toContain('Schweiz / EU')
    expect(html).toContain('Noah Baumann')
    expect(html).toContain('Einzelunternehmen')
  })
})
