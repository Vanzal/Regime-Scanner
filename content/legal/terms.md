...
7.5 **Open source.** Third-party open-source components are licensed under their own terms, listed at [https://nexusscopes.com/legal/oss].

---

## 8. Plans, fees, billing, and taxes

8.1 **Subscriptions.** The Service is offered on monthly or annual subscription plans. Prices, features, quotas, and any usage-based charges are those displayed at [https://nexusscopes.com/pricing] and in your order confirmation at the time of purchase.
...
16.3 **Fairness of terms.** These Terms are intended to comply with Art. 8 of the Swiss Unfair Competition Act (UWG/UCA), which makes it unfair to use general terms that, contrary to good faith, create a significant and unjustified imbalance between contractual rights and obligations to the detriment of consumers ([SECO](https://www.seco.admin.ch/seco/de/home/Werbe_Geschaeftsmethoden/Unlauterer_Wettbewerb/Missbrauchliche_Geschaftsbedingungen.html)), and with Directive 93/13/EEC on unfair terms in consumer contracts. Any clause that would be unfair under those rules does not apply to Consumers.
...
| Service Level Agreement | [https://nexusscopes.com/legal/sla] | Plans where offered |
| Open-source notices | [https://nexusscopes.com/legal/oss] | All users |

---

## Annex C — Operator checklist (internal — delete before publishing)

**Before you can rely on these Terms, put the following in place:**

1. **Publish the companion documents** listed in Annex B. A ToS that references a DPA and Privacy Policy that do not exist is a compliance gap in itself.
2. **Appoint an EU/EEA representative** under [Art. 27 GDPR](https://gdpr-info.eu/art-27-gdpr/) if you offer the Service to people in the EEA from Switzerland, and name them in Section 1 and in the Privacy Policy.
3. **Checkout flow:** button labelled "Order with obligation to pay"; total price with taxes shown for Consumers; two tick-boxes for Consumers who want immediate access (express request + acknowledgement of loss of withdrawal right) — without both, Section 9.4 does not protect you.
4. **Cancellation must be as easy as signing up** — a self-service cancel button in the account area, no phone-only or e-mail-only cancellation.
5. **Renewal reminders** for annual plans, per Section 8.4.
6. **Consent banner** for non-essential cookies with a reject option as prominent as accept.
7. **Scanning authorisation:** collect an explicit confirmation of ownership/authorisation at the point where a user adds a scan target. This is what makes Section 3.4 and the indemnity in 12.5 defensible.
