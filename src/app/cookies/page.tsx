  ...
  return (
    <div className="min-h-screen bg-[var(--ns-bg)] text-[var(--ns-fg)]">
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <p className="font-reading mt-3 text-sm text-[var(--ns-fg-muted)]">{l.cookies_intro}</p>

        <div className="mt-10 space-y-6 text-sm leading-relaxed">
          {l.cookie_sections.map((section, i) => (
            <section key={i} data-testid={`cookie-section-${i + 1}`}>
